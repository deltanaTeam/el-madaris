        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
              <li class="menu-item menu-item-submenu {{request()->routeIs('admin.profile.edit') ?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <li class="menu-item menu-item-submenu {{request()->routeIs('admin.teachers.*') ?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                      <span class="svg-icon svg-icon-primary svg-icon-2x">
                      @include('admin.layouts.icons.teachers')
                      </span>
                      <span class="menu-text mx-2">{{__('lang.teachers')}}</span>
                      <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                ...
                <li class="menu-item menu-item-submenu {{request()->routeIs('admin.students.*') ?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                         <span class="svg-icon svg-icon-primary svg-icon-2x">
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 28 28" version="1.1">
                         ...
                         <span class="menu-text mx-2">{{__('lang.students')}}</span>
                         <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                ...
                <li class="menu-item menu-item-submenu {{request()->routeIs('admin.videos.*') ?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                         <span class="svg-icon svg-icon-primary svg-icon-2x">
                           <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group.svg-->
                         ...
                         <span class="menu-text mx-2">{{__('lang.videos')}}</span>
                         <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
