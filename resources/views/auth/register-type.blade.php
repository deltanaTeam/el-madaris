...
<main class="flex-grow flex items-center justify-center px-4 py-10">
  <div
    class="w-full max-w-3xl bg-white rounded-xl shadow-md p-8 sm:p-12 b transition-all duration-300 ease-in-out"
    >
    <div class=" flex  justify-center">
     ...
     <div class="flex  justify-between border-4 border border-form-input  rounded-lg pt-4 my-2">
       <div class="mx-2">
       ...
       <div class="my-3 ">
         ...
         <p class="text-h4 text-sm md:text-lg">{{__('lang.you can register as a teacher')}}</p>
       </div>
       <a href="{{route('teachers.register')}}" class="h-9 md:h-12 theme-btn-md text-sm md:text-lg ">
       {{__('lang.register')}}
       </a>
     </div>
     <div class="flex  justify-between border-4 border border border-form-input dark:border-white rounded-lg pt-4 my-2">
       <div class="mx-3">
       ...
       <div class="my-3 m-end-12">
          ...
          <p class="text-h4 text-sm md:text-lg ">{{__('lang.you can register as a student')}}</p>

       </div>
       <a href="{{route('register')}}" class=" h-9 md:h-12 theme-btn-md text-sm md:text-lg  ">
       {{__('lang.register')}}
       </a>
     </div>
