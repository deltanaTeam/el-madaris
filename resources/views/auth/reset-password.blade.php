...
<main class="flex justify-center px-1 py-1">
  <div class="w-full max-w-2xl rounded-[2vw]  px-8 py-4 sm:p-12 transition-all  my-4 duration-300 ease-in-out bg-white shadow-md p-8 sm:p-12 " >
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-6" >
        ...
        <div>
          ...
          <input type="password" id="password" name="password" required minlength="8"
            class="w-full px-4 py-3 rounded-lg border-form-input  focus:border-input"
