...
class DesignButton
{
  ...
  // function __construct($show,$edit,$delete)
  // {
  //   $this->show_route = $show;
  //   $this->edit_route = $edit;
  //   $this->delete_route = $delete;
  // }
  /////////////////////////////////////////////////////////////////////////////////
    public function make_modal($body,$class,$actionType,$id){
   $idModel='Modal'.$id;
 ...
 <div class="modal-dialog">
   <div class="modal-content" style="overflow-y:scroll; max-height :650px;">
     ...
     <div class="modal-header">
       <h4 class="modal-title text-dark"> ' .$actionType.' '.$class.'</h4>
  ...
  public  function make_create_modal($id){
    $create = '<button class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#CreateModal0">
       &#10133; جديد
    </button>';
    return $create;
  }
  ...
  public  function make_delete_modal($id){
   ...
   $delete = '<a  class="btn btn-sm btn-light-danger rounded-0" data-toggle="modal" data-target="#Modal'.$id.'"  title="'.strtoupper(__("حذف")).'">
  ...
  public function make_disable_delete(){
    $delete = '<a href="" class="btn btn-sm btn-light btn-hover-danger btn-sm  disabled">
  ...
  public function make_disable_show(){
    $show = '<a href="" class=" disabled btn btn-sm btn-light-success rounded-0 border-white">
